...
if [ "$1" = "local" ];
    ...
    docker login --username=cn-east-2@VMKGNWR86FUNMDMKNPKJ --password=eefd5bebe0ada9a5edadmin8dba5d2a3075272f8f0d79e0f09616e ${REGISTRY_URL}
    #docker login -u cn-east-2@VMKGNWR86FUNMDMKNPKJ -p eefd5bebe0e349a5ed2fda22bf0a48admin3075272f8f0d79e0f09616e ${REGISTRY_URL}
    push_tag
    else
